...
pub fn build(b: *std.Build) void {
    ...
    lib_mod.addIncludePath(std.Build.LazyPath{ .cwd_relative = "//wsl.localhost/Ubuntu/home/zeon4/pspdev/psp/include" });
    ...
    const installAssembly = b.addInstallLibFile(lib.getEmittedBin(), "runtime.o");
